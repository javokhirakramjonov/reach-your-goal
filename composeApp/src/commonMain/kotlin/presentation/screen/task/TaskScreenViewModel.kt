...
import presentation.screen.task.mvi.event.ScreenEvent
import presentation.screen.task.mvi.state.ScreenUiState
...
class TaskScreenViewModel(
    ...
    private fun onTaskChanged(state: ScreenUiState, event: ScreenEvent.Input.TaskChanged): ScreenUiState {
